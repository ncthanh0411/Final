function onSignIn(e){var t=e.getBasicProfile();console.log("test");var n={id_gg:t.getId(),name:t.getName(),email:t.getEmail()};console.log(n),$.ajax({url:"/login",method:"post",data:n,success:function(e){window.location.replace("/")},error:function(e){alert(e.error)}})}function signOut(){gapi.auth2.getAuthInstance().signOut().then(function(){console.log("Sign Out"),window.location.replace("/logout")})}function newDepartment(){var e=$("#newDepartment").val();$.ajax({url:"/newDepartment",method:"post",data:{department:e},success:function(e){e.isvalid?$("#newDepartment").val(""):alert(e.msg)},error:function(e,t,n){console.log(err)}})}function createUser(){var e=$(".js-example-basic-multiple").select2("val");$.ajax({url:"/createUser",method:"post",data:{name:$("#newName").val(),username:$("#newUsername").val(),password:$("#newPassword").val(),confpassword:$("#newConfpassword").val(),department:JSON.stringify(e)},success:function(e){e.isvalid?($("#newName").val(""),$("#newUsername").val(""),$("#newPassword").val(""),$("#newConfpassword").val(""),$(".js-example-basic-multiple").val("").trigger("change")):alert(e.msg)},error:function(e,t,n){console.log(err)}})}window.onload=function(){gapi.load("auth2",function(){gapi.auth2.init()})},$(document).ready(function(){$(".js-example-basic-multiple").select2()}),$("#map-canvas").length&&jQuery(document).ready(function(e){var t;google.maps.event.addDomListener(window,"load",function(){var e={zoom:12,center:new google.maps.LatLng(37.048437,-100.921268)};t=new google.maps.Map(document.getElementById("map-canvas"),e);var n=new google.maps.Marker({map:t,icon:"images/map-marker.png",title:"Mi marcador",position:t.getCenter()}),o=new google.maps.Marker({map:t,icon:"images/map-marker2.png",title:"Otro marker",position:new google.maps.LatLng(37.07145,-100.900326)}),s=new google.maps.Marker({map:t,icon:"images/map-marker3.png",title:"Otro marker mas",position:new google.maps.LatLng(37.020208,-100.917492)}),a=new google.maps.InfoWindow;a.setContent("<b>Mi marcador</b><br>Tel: 46546545");var i=new google.maps.InfoWindow;i.setContent("<b>Otro marker</b><br>Tel: 46546545");var l=new google.maps.InfoWindow;l.setContent("<b>Otro marker mas</b><br>Tel: 46546545"),a.open(t,n),google.maps.event.addListener(n,"click",function(){a.open(t,n)}),google.maps.event.addListener(o,"click",function(){i.open(t,o)}),google.maps.event.addListener(s,"click",function(){l.open(t,s)})})}),jQuery(document).ready(function(e){e(".top-area > .setting-area > li").on("click",function(){return e(this).siblings().children("div").removeClass("active"),e(this).children("div").addClass("active"),!1}),e("body *").not(".top-area > .setting-area > li").on("click",function(){e(".top-area > .setting-area > li > div").removeClass("active")}),e(".user-img").on("click",function(){return e(".user-setting").toggleClass("active"),!1}),e(".friendz-list > li, .chat-users > li").on("click",function(){return e(".chat-box").addClass("show"),!1}),e(".close-mesage").on("click",function(){return e(".chat-box").removeClass("show"),!1}),e.isFunction(e.fn.perfectScrollbar)&&e(".dropdowns, .twiter-feed, .invition, .followers, .chatting-area, .peoples, #people-list, .chat-list > ul, .message-list, .chat-users, .left-menu").perfectScrollbar(),e(".trigger").on("click",function(){e(this).parent(".menu").toggleClass("active")}),e(".add-smiles > span").on("click",function(){e(this).parent().siblings(".smiles-bunch").toggleClass("active")}),e(".notification-box > ul li > i.del").on("click",function(){return e(this).parent().slideUp(),!1}),e(".f-page > figure i").on("click",function(){e(".drop").toggleClass("active")}),function(e){jQuery.expr[":"].Contains=function(e,t,n){return(e.textContent||e.innerText||"").toUpperCase().indexOf(n[3].toUpperCase())>=0},e(function(){var t,n,o,s;t=e("#searchDir"),n=e("#people-list"),o=e("<form>").attr({class:"filterform",action:"#"}),s=e("<input>").attr({class:"filterinput",type:"text",placeholder:"Search Contacts..."}),e(o).append(s).appendTo(t),e(s).change(function(){var t=e(this).val();return t?(e(n).find("li:not(:Contains("+t+"))").slideUp(),e(n).find("li:Contains("+t+")").slideDown()):e(n).find("li").slideDown(),!1}).keyup(function(){e(this).change()})})}(jQuery),e("body").show(),NProgress.start(),setTimeout(function(){NProgress.done(),e(".fade").removeClass("out")},2e3),e(function(){e('[data-toggle="tooltip"]').tooltip()}),e(window).width()<769&&jQuery(".sidebar").children().removeClass("stick-widget"),e.isFunction(e.fn.stick_in_parent)&&(e(".stick-widget").stick_in_parent({parent:"#page-contents",offset_top:60}),e(".stick").stick_in_parent({parent:"body",offset_top:0})),e(".we-page-setting").on("click",function(){e(".wesetting-dropdown").toggleClass("active")}),e("#nightmode").on("change",function(){e(this).is(":checked")?e(".theme-layout").addClass("black"):e(".theme-layout").removeClass("black")}),e.isFunction(e.fn.chosen)&&e("select").chosen(),e.isFunction(e.fn.userincr)&&e(".manual-adjust").userincr({buttonlabels:{dec:"-",inc:"+"}}).data({min:0,max:20,step:1}),e.isFunction(e.fn.loadMoreResults)&&e(".loadMore").loadMoreResults({displayedItems:3,showItems:1,button:{class:"btn-load-more",text:"Load More"}}),e.isFunction(e.fn.owlCarousel)&&e(".sponsor-logo").owlCarousel({items:6,loop:!0,margin:30,autoplay:!0,autoplayTimeout:1500,smartSpeed:1e3,autoplayHoverPause:!0,nav:!1,dots:!1,responsiveClass:!0,responsive:{0:{items:3},600:{items:3},1000:{items:6}}}),e.isFunction(e.fn.slick)&&(e(".slider-for-gold").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,slide:"li",fade:!1,asNavFor:".slider-nav-gold"}),e(".slider-nav-gold").slick({slidesToShow:3,slidesToScroll:1,asNavFor:".slider-for-gold",dots:!1,arrows:!0,slide:"li",vertical:!0,centerMode:!0,centerPadding:"0",focusOnSelect:!0,responsive:[{breakpoint:768,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,vertical:!1,centerMode:!0,dots:!1,arrows:!1}},{breakpoint:641,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,vertical:!0,centerMode:!0,dots:!1,arrows:!1}},{breakpoint:420,settings:{slidesToShow:3,slidesToScroll:1,infinite:!0,vertical:!1,centerMode:!0,dots:!1,arrows:!1}}]})),e(function(){e("#menu").mmenu(),e("#shoppingbag").mmenu({navbar:{title:"General Setting"},offCanvas:{position:"right"}}),e(".mh-head.first").mhead({scroll:{hide:200}}),e(".mh-head.second").mhead({scroll:!1})}),e("span.main-menu").on("click",function(){return e(".side-panel").addClass("active"),e(".theme-layout").addClass("active"),!1}),e(".theme-layout").on("click",function(){e(this).removeClass("active"),e(".side-panel").removeClass("active")}),e("button.signup").on("click",function(){return e(".login-reg-bg").addClass("show"),!1}),e(".already-have").on("click",function(){return e(".login-reg-bg").removeClass("show"),!1}),e.isFunction(e.fn.downCount)&&e(".countdown").downCount({date:"11/12/2018 12:00:00",offset:10}),jQuery(".post-comt-box textarea").on("keydown",function(t){if(13==t.keyCode){var n=jQuery(this).val(),o=jQuery(".showmore").parent("li");e('\t<li><div class="comet-avatar"><img src="images/resources/comet-1.jpg" alt=""></div><div class="we-comment"><div class="coment-head"><h5><a href="time-line.html" title="">Jason borne</a></h5><span>1 year ago</span><a class="we-reply" href="#" title="Reply"><i class="fa fa-reply"></i></a></div><p>'+n+"</p></div></li>").insertBefore(o),jQuery(this).val("")}}),e(".message-list > li > span.star-this").on("click",function(){e(this).toggleClass("starred")}),e(".message-list > li > span.make-important").on("click",function(){e(this).toggleClass("important-done")}),e("#select_all").on("click",function(t){this.checked?e("input:checkbox.select-message").each(function(){this.checked=!0}):e("input:checkbox.select-message").each(function(){this.checked=!1})}),e(".delete-email").on("click",function(){e(".message-list .select-message").each(function(){this.checked&&e(this).parent().slideUp()})}),e(".category-box").hover(function(){e(this).addClass("selected"),e(this).parent().siblings().children(".category-box").removeClass("selected")});const t=document.querySelector("#toggle"),n=document.querySelector("#overlay"),o=document.querySelector(".menu-container"),s=document.querySelector(".canvas-menu i");t&&t.addEventListener("click",function(e){n.classList.toggle("open"),o.classList.toggle("full-menu"),s.classList.toggle("fa-bars"),s.classList.add("fa-times"),e.preventDefault()},!1),e(".offcanvas-menu li.menu-item-has-children > a").on("click",function(){return e(this).parent().siblings().children("ul").slideUp(),e(this).parent().siblings().removeClass("active"),e(this).parent().children("ul").slideToggle(),e(this).parent().toggleClass("active"),!1})});
